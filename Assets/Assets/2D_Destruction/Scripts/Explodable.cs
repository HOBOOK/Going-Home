...
public class Explodable : MonoBehaviour
{
    ...
    public void explode()
    {
        ...
        else
        {
            ...
            {
                frag.transform.parent = this.transform.parent;
                frag.SetActive(true);
            }
        }
    ...
    {
        if((collision.CompareTag("obstacle")||collision.CompareTag("attackPoint") || collision.gameObject.layer==26)&& GetComponent<Explodable>()!=null)
        {
            if (GetComponent<AudioSource>() != null)
                SoundManager.instance.EffectSourcePlay(GetComponent<AudioSource>().clip);
